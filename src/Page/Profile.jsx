  ...
  return (
    ...
    <div className="profile-page">
      ...
      <div className="top-bar">
        ...
        <div className="icons">
          <button><Link to='/profileedit'><FiEdit/></Link></button>
          <button><Link to='/setting'><FiSettings/></Link></button>
        </div>
      </div>
  ...
  <div className="vibe-content">
    ...
    <p>{vibe.desc}</p>
      ...
      <section className="profile-card">
        ...
        <p><Link to='/profileedit' style={{color:'inherit'}}>+ Add more photos</Link></p>
        <p><Link to='/profileedit' style={{color:'inherit'}}>+ Add prompts</Link></p> 
        <p>+ Verify account</p>
      </section>
